...
// options coming from the real API automatically gets a consistent,
// meaningful colour without anyone picking it manually.
export const RISK_GRADIENTS: Record<
  string,
    ...
    fetch(`${API_URL}/investments`)
      ...
      .then((data) => {
        if (data.success) {
          ...
          setError(data.message || "Could not load investment options.");
        }
      })
