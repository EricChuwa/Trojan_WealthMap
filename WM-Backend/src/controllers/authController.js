...
const register = async (req, res) => {
  const { first_name, last_name, email, password, phone_number, country, date_of_birth } = req.body;
  ...
  try {
    ...
    const result = await pool.query(
      ...
      [first_name, last_name, email, passwordHash, phone_number, country, date_of_birth]
    );
